...
public class QuartzEntity{
	...
	public QuartzEntity(String jobName, String jobGroup, String description, String jobClassName, String jobMethodName,
			String cronExpression, String triggerName, String triggerState, String oldJobName, String oldJobGroup) {
		super();
